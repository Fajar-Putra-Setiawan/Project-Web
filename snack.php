...
<div class="pure-menu pure-menu-horizontal">
    ...
    <ul class="pure-menu-list">
        ...
        <li class="pure-menu-item"><a href="cart2.php" class="pure-menu-link">Carts</a></li>
    </ul>
</div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="row row-cols-3">
                    ...
                    <div class="col">
                        <img src="photo2/<?php echo $data['photo'];?>" style=width:400px;height:268px; >
                        <div class="caption">
                            <h2><?php echo $data['nama_produk']; ?></h2>
                            <h5><?php echo $data['caption']; ?></h5>
                            <h5>Rp. <?php echo number_format($data['harga_produk']); ?></h5>
                            <a href="beli2.php?id=<?php echo $data['id_produk']; ?>" class="btn btn-primary">Buy</a>
                        </div>
                    </div>
                    <?php }?>
                </div>
